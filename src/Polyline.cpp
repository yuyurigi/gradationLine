...
void Polyline::setLineColor(int midColor, ofColor returnColor[3]){
    ...
    int prevColor = midColor-1;
    if (prevColor == -1)  prevColor = 2;
    int nextColor = midColor+1;
...
//--------------------------------------------------------------
void Polyline::setColor(ofColor _lineColor0, ofColor _lineColor1, ofColor _lineColor2){
...
void Polyline::drawLine_first(){
    ...
    mesh1.addIndex(3);
    if(bGradation){
        mesh1.addColor(lineColor[0]);
        mesh1.addColor(lineColor[0]);
        ofColor lerpColor = lineColor[1];
        lerpColor.lerp(lineColor[0], 0.5);
